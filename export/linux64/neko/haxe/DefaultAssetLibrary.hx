...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/enemy3.png", "assets/enemy3.png");
		type.set ("assets/enemy3.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/enemies.png", "assets/enemies.png");
		type.set ("assets/enemies.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/enemy.svg", "assets/enemy.svg");
		type.set ("assets/enemy.svg", Reflect.field (AssetType, "text".toUpperCase ()));
		...
		path.set ("assets/enemy5.png", "assets/enemy5.png");
		type.set ("assets/enemy5.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/enemy4.png", "assets/enemy4.png");
		type.set ("assets/enemy4.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/sounds/beep.ogg", "assets/sounds/beep.ogg");
		type.set ("assets/sounds/beep.ogg", Reflect.field (AssetType, "sound".toUpperCase ()));
		path.set ("assets/sounds/flixel.ogg", "assets/sounds/flixel.ogg");
		type.set ("assets/sounds/flixel.ogg", Reflect.field (AssetType, "sound".toUpperCase ()));
		path.set ("assets/enemy2.png", "assets/enemy2.png");
		type.set ("assets/enemy2.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/sounds/flixel.ogg", "assets/sounds/flixel.ogg");
		type.set ("assets/sounds/flixel.ogg", Reflect.field (AssetType, "sound".toUpperCase ()));
		path.set ("assets/sounds/beep.ogg", "assets/sounds/beep.ogg");
		type.set ("assets/sounds/beep.ogg", Reflect.field (AssetType, "sound".toUpperCase ()));
